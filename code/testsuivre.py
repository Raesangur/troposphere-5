...
def start_moving(lf, vitesseBase = 100):
    ...
    while lf.read_digital() != [True, True, True, True, True]:
        ...
        if rd == [False, False, True, False, False]:
            angle = 90
        if rd == [False, False, True, True, False] or rd == [False, False, False, True, False] or rd == [False, False, False, True, True] or rd == [False, False, False, False, True]:
            angle = 90 + angle
        if rd == [False, True, True, False, False] or rd == [False, True, False, False, False] or rd == [True, True, False, False, False] or rd == [True, False, False, False, False]:
            angle = 90 - angle
        else:
            print("wtf")
